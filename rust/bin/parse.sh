...
"$ROOT_DIR"/joern-parse -J-Xmx25G "$INPUT_DIR" --output "$CPG_PATH"

# $EXTRA_ARGS --language RUSTLANG --frontend-args --rust-parser-path /home/hieucien/Workspace/joern/joern-cli/frontends/rustsrc2cpg/bin/rust-parser/rust-parser
